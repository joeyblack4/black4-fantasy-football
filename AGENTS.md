...
Current decisions are in docs/DECISIONS.md; PROJECT_BRIEF.md points to the current plan; the early brief is archived. Work is an early build, not a launch claim. No live public messages, paid purchases, or changes to customer infrastructure are part of this build. Record account/payment dependencies in docs/JOEY_ACTIONS.md.
