...
| `src/publication/`, `public/`                             | Public scoreboard projection (`scoreboard.ts`, published to Cloudflare KV by `scripts/public-scoreboard.ts`), the legacy custom-engine projection, and local commissioner/human controls. |
