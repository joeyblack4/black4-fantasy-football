...
- The first real owner-turn canary published its reply at 2026-09-10 19:18 UTC. Provider usage moved from **$146.166544** before the turn to **$146.372252** at reply-send time: **$0.205708** at that checkpoint. Qwen then performed post-send verification and logging; after the turn was fully complete, provider usage stabilized at **$146.540946**, making the authoritative whole-turn delta **$0.374402**. This is why reconciliation must occur after completion rather than at answer-send time.
- Qwen reported 8 of the 25 allowed tool calls in its reply. Because additional post-send activity followed, that count is not independently reconciled; the external 25-call ceiling remains configured.
