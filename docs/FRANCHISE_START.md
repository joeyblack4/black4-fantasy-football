...
For shared Black4 business integrations, read [PLATFORM_CONTROL.md](PLATFORM_CONTROL.md) and run `node ./platform-control discover --channel CHANNEL_ID` using your current Fantasy channel. All enrolled agents receive the same server-governed access. This does not change publishing, spending, or customer-access authority.
